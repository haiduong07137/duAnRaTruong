...
class ProductDialog extends Component {
  ...
  componentWillMount() {
    if (
      typeof this.props.item.landingPages !== "undefined" &&      this.props.item.landingPages !== null
    ) {
      this.props.item.landingPages.forEach(
        (landingPage) => (landingPage.tempId = shortId.generate())
      );
    }
    this.setState(
      {
        ...
        */}
        ...
        {this.state.shouldOpenDialog && (
          <ConfirmationDialog
            ...
            onYesClick={() => {
              this.setState({ shouldOpenListAgencyToAddProduct: true });
            }}
