...
class UploadFormPopup extends React.Component {
  ...
  fileUpload(file) {
    ...
    formData.append('uploadFile', file);//Lưu ý tên 'uploadAvatar'
    formData.append('userId', this.props.userId);//Lưu ý tên 'uploadfile' phải trùng với tham số bên Server side
    const config = {
      headers: {
