                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        {this.state.product?.currencyPayout === "THB"
                          ? "THB"
                          : this.state.product?.currencyPayout === "VND"
                            ? "VND"
                            : this.state.product?.currencyPayout === "USD"
                              ? "USD"
                              : "IDR"}
                      </InputAdornment>
                    ),
                ...
                <Autocomplete
                  ...
                  defaultValue={() => {
                    const defaultCurrency = currencies.filter(
                      (currencyD) => this.props.currency === currencyD.value
                    )
