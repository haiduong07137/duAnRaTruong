...
class MyOffers extends Component {
  ...
  handleSearch = (query) => {
    this.setState({ keyword: query }, () => this.callSearchByPage())
  }
  ...
  filterProductOnProperty = (property, value = [], currency = '') => {
    let { myOfferList = [] } = this.props
    let filteredMyOfferList = myOfferList
    let searchObject = {
      keyword: this.state.keyword,
      pageIndex: this.state.page + 1,
      pageSize: this.state.rowsPerPage,
        ...
        <EgretSidenavContainer>
          ...
          <EgretSidenavContent>
            <OfferContainer
              orderBy={orderBy}
              view={view}
              offerList={this.props.myOfferList}
              totalOffer={this.props.totalMyOffer}
              page={page}
...
const mapStateToProps = (state) => ({
  ...
  myOfferList: state.ecommerce.myOfferList,
  totalMyOffer: state.ecommerce.totalMyOffer,
