...
export default function Asynchronous(props) {
  ...
  return (
    <Autocomplete
      ...
      getOptionLabel={(option) => (props.selectChildName && option[props.selectChildName]) ? ((props.displayLable) ? option[props.selectChildName][props.displayLable] : option[props.selectChildName].code) : ((props.displayLable) ? option[props.displayLable] : option.code)}
      options={options}
