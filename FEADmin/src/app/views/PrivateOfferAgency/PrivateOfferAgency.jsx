...
class Agency extends Component {
  ...
  gotoListValidate(idOffer) {
    this.props.history.push({
      pathname: ConstantList.ROOT_PATH + "agency/my-offer/validate/" + idOffer,
      state: {
        rowsPerPage: 10,
        page: 0,
        keyword: ""
            ...
            onSelect={(rowData, method) => {
              ...
              if (method === 0) {
                this.setState({
                  shouldOpenEditorDialog: true,
                  offerID: rowData.id,
                  currency: rowData.product.currency,
                });
                console.log(rowData.product.currency);
              } else if (method === 1) {
                let offer = {
                  id: rowData.id,
                };
                ...
                this.gotoListValidate(rowData.id)
              } else {
