...
class Categories extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      // },
      { title: "Name", field: 'name', align: 'left', width: '150' },
      { title: "Phone", field: 'phone', align: 'left', width: '150' },
      {
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: "Danh sách Lead"}]} />
        </div>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            ...
            <TextField
              label={"Tìm kiếm với tên hoặc số điện thoại"}
