...
class Categories extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      // },
      { title: "STT", field: 'name', align: 'left', width: '150' },
      { title: "Keylock", field: 'keyLock', align: 'left', width: '150' },
      { title: "Value", field: 'value', align: 'left', width: '150' },
      {
    ...
    return (
      <div className="m-sm-30">
        ...
        <div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: "Danh sách Validate"}]} />
        </div>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            ...
            <TextField
              label={"Tìm kiếm với kelock hoặc value"}
