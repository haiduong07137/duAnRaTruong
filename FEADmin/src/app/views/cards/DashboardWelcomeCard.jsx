    ...
    <Grid container spacing={3}>
          ...
          <a href={ConstantList.ROOT_PATH + "asset/list_asset"} >
            <div className="font-weight-300 flex flex-space-between">
              <div className="text-white margin-auto">
                <div className="font-size-32"><b>{t('Tổng số')}</b></div>
      ...
      <Grid item lg={2} md={2} sm={6} xs={12}>
        ...
        >
          ...
          <div className="font-weight-300 flex flex-space-between">
            <div className="text-white margin-auto">
              <div className="font-size-32"><b>{t('Thành Tiền')}</b></div>
              <p className="uppercase m-0"><b>{price.toLocaleString("en-US")}d</b></p>
            </div>
          </div>
          </a>
        </Card>
